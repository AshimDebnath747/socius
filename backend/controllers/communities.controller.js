...
export const acceptJoinRequestController = async (req, res) => {
  try {
    ...
    const userId = req.user.id;
    const result = await acceptJoinRequestService(
      communityId,
      requestId,
      userId,
    );
...
export const checkMembershipController = async (req, res) => {
  try {
    ...
    const role = await checkMembershipService(communityId, userId);
...
export const uploadCommunityMediaController = async (req, res) => {
  try {
